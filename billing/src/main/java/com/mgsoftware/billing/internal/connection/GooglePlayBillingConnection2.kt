...
class GooglePlayBillingConnection2(
    ...
    private val billingClientListener = object : BillingClientStateListener {
        ...
        override fun onBillingSetupFinished(billingResult: BillingResult) {
            connectingResult.trySend(billingResult)
        }
    }

    private val connectingResult = Channel<BillingResult>()
    ...
    private suspend fun establishConnection() = mutex.withLock {
        retry(
